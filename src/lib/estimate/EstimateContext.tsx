...
import { buildBlankDraft, type CoverInfo, type PersistedDraft } from './draft';
import { upsertLine } from './upsertLine';

const PERSIST_DEBOUNCE_MS = 500;

// Re-exported for backward compatibility with existing client-side importers (this module's own
// test file, other client components). Server Components must import these from './draft'
// directly instead — re-exporting them here does NOT help server-side callers, since Next.js
// treats every export of a 'use client' module as a client reference, including re-exports.
export { buildBlankDraft, normalizeDraft } from './draft';
export type { CoverInfo, PersistedDraft } from './draft';
